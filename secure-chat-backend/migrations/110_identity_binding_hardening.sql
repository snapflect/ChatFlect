...
-- 2. Add composite unique index for strict dedup enforcement
CREATE UNIQUE INDEX IF NOT EXISTS idx_msg_sender_dedup
    ON messages (sender_id, sender_device_uuid, message_uuid);
