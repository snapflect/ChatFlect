-- Database Restore Script (v3 Hybrid)
-- Hybrid Identity: Google/Email Auth + Mandatory Phone Registration
-- Usage: Run this in phpMyAdmin or MySQL CLI to reset the database.
...
-- 3. OTPs Table (Email-based verification)
CREATE TABLE `otps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(100) NOT NULL,
  `phone_number` varchar(50) DEFAULT NULL, -- Optional, used when verifying a NEW phone number
...
-- 4. Contacts Table (Hybrid Discovery)
