...
-- MASTER CLEANUP: DROP ALL 122 TABLES --
SET FOREIGN_KEY_CHECKS = 0;
DROP TABLE IF EXISTS `abuse_correlation`;
DROP TABLE IF EXISTS `abuse_events`;
DROP TABLE IF EXISTS `abuse_scores`;
DROP TABLE IF EXISTS `admin_actions`;
DROP TABLE IF EXISTS `admin_action_queue`;
DROP TABLE IF EXISTS `admin_identities`;
DROP TABLE IF EXISTS `alias_history_receipts`;
DROP TABLE IF EXISTS `anonymous_profiles`;
DROP TABLE IF EXISTS `api_metrics`;
DROP TABLE IF EXISTS `archive_snapshots`;
DROP TABLE IF EXISTS `attachments`;
DROP TABLE IF EXISTS `attachment_keys`;
DROP TABLE IF EXISTS `attachment_receipts`;
DROP TABLE IF EXISTS `backup_blobs`;
DROP TABLE IF EXISTS `backup_jobs`;
DROP TABLE IF EXISTS `broadcast_lists`;
DROP TABLE IF EXISTS `broadcast_list_members`;
DROP TABLE IF EXISTS `call_audit_logs`;
DROP TABLE IF EXISTS `call_lockdowns`;
DROP TABLE IF EXISTS `call_moderation_events`;
DROP TABLE IF EXISTS `call_participants`;
DROP TABLE IF EXISTS `call_ratchet_state`;
DROP TABLE IF EXISTS `chat_sequences`;
DROP TABLE IF EXISTS `compliance_exports`;
DROP TABLE IF EXISTS `compliance_export_modules`;
DROP TABLE IF EXISTS `compliance_settings`;
DROP TABLE IF EXISTS `contact_verifications`;
DROP TABLE IF EXISTS `conversations`;
DROP TABLE IF EXISTS `conversation_device_markers`;
DROP TABLE IF EXISTS `conversation_moderation_state`;
DROP TABLE IF EXISTS `conversation_privacy_settings`;
DROP TABLE IF EXISTS `conversation_ttl_rules`;
DROP TABLE IF EXISTS `deletion_receipts`;
DROP TABLE IF EXISTS `delivery_security_events`;
DROP TABLE IF EXISTS `devices`;
DROP TABLE IF EXISTS `device_audit_logs`;
DROP TABLE IF EXISTS `device_events`;
DROP TABLE IF EXISTS `device_inbox`;
DROP TABLE IF EXISTS `device_sessions`;
DROP TABLE IF EXISTS `device_sync_watermarks`;
DROP TABLE IF EXISTS `feature_entitlements`;
DROP TABLE IF EXISTS `feature_flags`;
DROP TABLE IF EXISTS `gdpr_delete_jobs`;
DROP TABLE IF EXISTS `governance_policies`;
DROP TABLE IF EXISTS `group_audit_log`;
DROP TABLE IF EXISTS `group_audit_logs`;
DROP TABLE IF EXISTS `group_join_requests`;
DROP TABLE IF EXISTS `group_messages`;
DROP TABLE IF EXISTS `group_receipts`;
DROP TABLE IF EXISTS `group_sender_keys`;
DROP TABLE IF EXISTS `group_sender_key_state`;
DROP TABLE IF EXISTS `group_sequences`;
DROP TABLE IF EXISTS `identity_keys`;
DROP TABLE IF EXISTS `ip_banlist`;
DROP TABLE IF EXISTS `legal_holds`;
DROP TABLE IF EXISTS `media_audit_logs`;
DROP TABLE IF EXISTS `message_expiry_queue`;
DROP TABLE IF EXISTS `message_forward_events`;
DROP TABLE IF EXISTS `message_idempotency`;
DROP TABLE IF EXISTS `message_receipts`;
DROP TABLE IF EXISTS `message_replay_log`;
...
DROP TABLE IF EXISTS `org_call_policies`;
DROP TABLE IF EXISTS `org_invites`;
DROP TABLE IF EXISTS `org_licenses`;
DROP TABLE IF EXISTS `org_license_events`;
DROP TABLE IF EXISTS `org_members`;
DROP TABLE IF EXISTS `org_message_policies`;
DROP TABLE IF EXISTS `org_policies`;
DROP TABLE IF EXISTS `org_retention_policies`;
DROP TABLE IF EXISTS `org_sso_settings`;
DROP TABLE IF EXISTS `org_sso_states`;
DROP TABLE IF EXISTS `prekey_audit_log`;
...
DROP TABLE IF EXISTS `recovery_phrases`;
DROP TABLE IF EXISTS `redaction_policies`;
DROP TABLE IF EXISTS `scim_events`;
DROP TABLE IF EXISTS `scim_tokens`;
DROP TABLE IF EXISTS `security_alerts`;
DROP TABLE IF EXISTS `security_audit_log`;
DROP TABLE IF EXISTS `security_events`;
DROP TABLE IF EXISTS `signed_prekey_rotations`;
...
DROP TABLE IF EXISTS `vulnerability_attachments`;
DROP TABLE IF EXISTS `vulnerability_reports`;
...
-- 
-- SOURCE: 109_sender_key_versioning.sql
-- 


-- 109_sender_key_versioning.sql
...
-- MISSING TABLES INJECTED FROM status.php --
...
CREATE TABLE IF NOT EXISTS status_reactions (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uniq_reaction (status_id, user_id),
    FOREIGN KEY (status_id) REFERENCES status_updates(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
